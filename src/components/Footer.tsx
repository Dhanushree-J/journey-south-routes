    ...
    <footer className="bg-gray-900 dark:bg-gray-950 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <h3 className="text-2xl font-bold mb-4">BusGo</h3>
            ...
            <div className="flex space-x-4">
              ...
              <Button onClick={toggleTheme} variant="ghost" size="icon" className="text-white hover:text-blue-400">
                {isDarkMode ? 
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li><a href="/" className="hover:text-white">Bangalore to Bhatkal</a></li>
              <li><a href="/" className="hover:text-white">Bangalore to Mantralaya</a></li>
              <li><a href="/" className="hover:text-white">Bangalore to Goa</a></li>
              <li><a href="/" className="hover:text-white">Chikkamagaluru to Bangalore</a></li>
              <li><a href="/" className="hover:text-white">Hassan to Bhatkal</a></li>
            </ul>
          </div>
          
          <div>
            <h4 className="text-lg font-semibold mb-4">Bus Types</h4>
            <ul className="space-y-2 text-gray-300">
              <li><a href="/" className="hover:text-white">AC Sleeper</a></li>
              <li><a href="/" className="hover:text-white">Non-AC Sleeper</a></li>
              <li><a href="/" className="hover:text-white">Volvo AC</a></li>
              <li><a href="/" className="hover:text-white">Deluxe</a></li>
              <li><a href="/" className="hover:text-white">Express</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-300">© 2025 BusGo. All rights reserved.</p>
